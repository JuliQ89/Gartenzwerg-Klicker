...
const Gartenzwerg = ({ image }) => {
  const scherbenAnzahlVergroesern = useKlickerStore((state) => state.scherbenAnzahlVergroesern);
  ...
  return (
    <div className='z-10 cursor-pointer scale-100 transition-all ease-in duration-200 hover:scale-105' onClick={onGartenzwergKlick}>
